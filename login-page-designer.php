 ...
 *Plugin URI: #
 *Description: Simple Login page Styler provides you to easy way to customize the appearance of the wordPress login page with many options. 
 *Version: 1.1 
 *Author: Shantanu Vishwanadha   
 *Author URI:http://www.thecoderpanda.site/            
 *License: GPLv2      
 */        
...
add_action('wp_enqueue_scripts', 'wlpd_login_designer_scripts'); //add  custom scrollbar scripts 
